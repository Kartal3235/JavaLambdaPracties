...
public class C7_DosyaOkuma {
    public static void main(String[] args) throws IOException {
        ...
        Stream<String> satir= Files.lines(Path.of("src/lambdaPractise/C7_TextFile"));
    ...
    //S2: tum harflari buyuk harf ile yazdiralim
        satir.map(String::toUpperCase).forEach(System.out::print);

    // S3: son satiri buyuk harfle yazdiralim
        satir.skip(4).map(String::toUpperCase).forEach(System.out::print);

    //S4: 2.ve 3. satirlari yazdiralim
        satir.skip(1).limit(2).forEach(System.out::print);
